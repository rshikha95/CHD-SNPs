...
## Step 1: Download the SNPs data from GWAS-catalog and Clinvar database using following links: 
## (a) GWAS-Catalog data link: https://www.ebi.ac.uk/gwas/docs/file-downloads
...
chd_traits<- read.table("CHD_traits.txt") # Download CHD-traits list from Supplementary Table 1
